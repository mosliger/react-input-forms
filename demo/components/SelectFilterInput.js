...
import getprosTypeSelectFilterInput from '../helpers/selectFilterInput';
...
export default class SelectFilterInput extends Component {
  state = {
    selectInput: '',
    selectInputRules: '',
    selectInputChildren: '',
  ...
  renderBasicInput = () => {
    ...
    return (
      <div>
        <InputField type="select-filter" options={optionList} value={basicinput} name="basicinput" label="basic input " onChange={this.handleUpdateValue} />
        <pre>
          <code>
            {`
const optionList = [
...
/>
  ...
  renderCustomElement = () => {
    ...
    return (
      <div>
        <InputField type="select-filter" options={optionList} customElement={this.customElementSelect} value={customElement} name="customElement" label="custom element" onChange={this.handleUpdateValue} />
        <pre>
          <code>
            {`
customElementSelect = (input, label, errorMessage) => {
...
/>
  ...
  render() {
    const prosType = getprosTypeSelectFilterInput('th');
    return (
      <div className="container">
        <h1>Input Type Select Filter</h1>
        <div className="row">
